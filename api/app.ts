...
// 微信公开接口限流 - 更严格
const wechatPublicLimiter = rateLimit({
  windowMs: 5 * 60 * 1000,
  max: 30,
  message: {
    success: false,
    error: {
      message: 'Too many requests for wechat public API, please try again later.',
      code: 'RATE_LIMIT_EXCEEDED',
      statusCode: 429
    }
  }
...
app.use('/api/wechat-public', wechatPublicLimiter)
